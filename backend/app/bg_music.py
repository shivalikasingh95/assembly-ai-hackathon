...
def generate_music(config: dict, midi_file_path: str):
    ...
    model_path = "/home/ubuntu/AssemblyAI/assembly-ai-hackathon/backend/artifacts/symphonynet/checkpoint_last_linear_4096_chord_bpe_hardloss1_PI2.pt" 
    #get_music_gen_model(config['wandb_project_name'])
    ...
    convert_midi_to_mp3(midi_output_name, mp3_output_name, config['sampling_rate'])
